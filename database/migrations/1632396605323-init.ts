...
export class init1632396605323 implements MigrationInterface {
    name = 'init1632396605323'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `token` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` bigint NOT NULL AUTO_INCREMENT, `type` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `symbol` varchar(255) NOT NULL, `address` varchar(255) NOT NULL, `decimals` int NOT NULL, `total_supply` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `price_address` varchar(255) NULL, `price_value` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `icon_link` varchar(255) NULL, `networkId` bigint NULL, `pair0Id` bigint NULL, `pair1Id` bigint NULL, UNIQUE INDEX `idx_token_1` (`networkId`, `address`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `nf_token` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` bigint NOT NULL AUTO_INCREMENT, `address` varchar(255) NOT NULL, `index` int NOT NULL, `token_uri` varchar(255) NULL, `image_or_animation_uri` varchar(255) NULL, `protocolId` bigint NULL, INDEX `idx_nfToken_1` (`protocolId`, `address`, `index`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `farm_reward_token` (`id` bigint NOT NULL AUTO_INCREMENT, `farmId` bigint NULL, `tokenId` bigint NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `farm_stake_token` (`id` bigint NOT NULL AUTO_INCREMENT, `farmId` bigint NULL, `tokenId` bigint NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `farm` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` bigint NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `address` varchar(255) NULL, `pid` int NULL, `assets` varchar(255) NOT NULL, `liquidity_amount` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `liquidity_value` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `apy` varchar(255) NULL, `apr` varchar(255) NULL, `data` varchar(255) NULL, `link` varchar(255) NULL, `protocolId` bigint NULL, UNIQUE INDEX `idx_farm_3` (`protocolId`, `address`, `pid`), INDEX `idx_farm_2` (`protocolId`, `pid`), INDEX `idx_farm_1` (`protocolId`, `address`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `lending` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` bigint NOT NULL AUTO_INCREMENT, `address` varchar(255) NULL, `pid` int NULL, `liquidity_amount` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `liquidity_value` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `supply_amount` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `supply_value` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `supply_apr` varchar(255) NULL, `borrow_amount` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `borrow_value` decimal(65,22) NOT NULL DEFAULT '0.0000000000000000000000', `borrow_apr` varchar(255) NULL, `data` varchar(255) NULL, `collateral_factor` tinyint NULL, `reserve_factor` tinyint NULL, `link` tinyint NULL, `protocolId` bigint NULL, `tokenId` bigint NULL, UNIQUE INDEX `idx_lending_3` (`protocolId`, `address`, `pid`), INDEX `idx_lending_2` (`protocolId`, `pid`), INDEX `idx_lending_1` (`protocolId`, `address`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `scheduler` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` varchar(36) NOT NULL, `type` varchar(255) NOT NULL, `identity_path` varchar(255) NOT NULL, `cron` varchar(255) NOT NULL, `block_number` int NULL, `pid` int NULL, `error` varchar(255) NOT NULL DEFAULT '0', `error_msg` varchar(255) NULL, `process` tinyint NOT NULL DEFAULT '0', `protocolId` bigint NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `protocol` (`status` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp NULL, `id` bigint NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `check_farm` tinyint NOT NULL DEFAULT 0, `check_nft` tinyint NOT NULL DEFAULT 0, `check_lending` tinyint NOT NULL DEFAULT 0, `link` varchar(255) NULL, `logo_link` varchar(255) NULL, `networkId` bigint NULL, `tokenId` bigint NULL, UNIQUE INDEX `idx_protocol_1` (`networkId`, `tokenId`), UNIQUE INDEX `REL_7c80dacfc51fc3d3321a53c58f` (`tokenId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `abi` (`id` bigint NOT NULL AUTO_INCREMENT, `address` varchar(255) NOT NULL, `data` longtext NOT NULL, `networkId` bigint NULL, UNIQUE INDEX `idx_abi_1` (`networkId`, `address`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `farm_reward_token` ADD CONSTRAINT `FK_accb1767d39cf0fdb3c9a7551c5` FOREIGN KEY (`tokenId`) REFERENCES `token`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `farm_stake_token` ADD CONSTRAINT `FK_3c0cda572bf6d3a412f8f4a5475` FOREIGN KEY (`tokenId`) REFERENCES `token`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
